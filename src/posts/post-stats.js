...
//         <div className="row pt-2">
//             <div className="col-2">
//                 <i className="bi bi-chat text-secondary" onClick={toggleComments}></i>
//                 <span className="text-secondary ps-2">{comments.length}</span>
//                 {showComments && (
//                     <>
//                         <button
...
//                         </button>
//                         {showCommentForm && (
//                             <CommentForm postId={post._id} handleSubmit={handleSubmit} />
//                         )}
//                         {comments.map((comment) => (
...
//             });
//         }
//     }, [dispatch, post._id, showComments]);
//     // useEffect(() => {
//     //     dispatch(getCommentsThunk({pid: post._id})).then((data) => {
//     //         setComments(data.payload);
//     //     });
...
//         <div className="row pt-2">
//             <div className="col-2">
//                 <i className="bi bi-chat text-secondary" onClick={handleShowComments}></i>
//                 <span className="text-secondary ps-2">
//                     {comments.length > 0 && (
//                         <span className="ps-2">{comments.length}</span>
//                     )}
//                 {showComments && (
//                     <>
//               {comments.map((comment) => (
